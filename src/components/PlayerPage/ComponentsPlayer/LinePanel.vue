   ...
   <div>
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="3">
        ...
        <indents v-model="value.style.bottom" :count="1"></indents>
      </el-col>


      <el-col :span="6">
				<label class="form__label--small">Высота полосы</label>
				<value-px v-model="value.styleLine.height"></value-px>
			</el-col>
			<el-col :span="3">
        ...
        <el-color-picker v-model="value.stylePlay.background" size="small" show-alpha></el-color-picker>
			...
			<el-col :span="3">
        <label class="form__label--small">Цвет буфера</label>
        <el-color-picker v-model="value.styleLoad.background" size="small" show-alpha></el-color-picker>
      </el-col>
